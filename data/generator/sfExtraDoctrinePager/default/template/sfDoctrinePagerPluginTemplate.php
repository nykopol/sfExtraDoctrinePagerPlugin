...
/**
 * Plugin<?php echo $this->table->getOption('name') ?> pager.
 *
 * @package    ##PROJECT_NAME##
 * @subpackage sfExtraDoctrinePagerPlugin
 * @author     ##AUTHOR_NAME##
 */
abstract class Plugin<?php echo $this->table->getOption('name') ?>Pager extends Base<?php echo $this->table->getOption('name') ?>Pager
{
